...
function vw_restaurant_lite_activation_notice() {
	echo '<div class="notice notice-success is-dismissible">';
		...
		echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=vw_restaurant_lite_guide' ) ) .'" class="button button-primary">'. esc_html__( 'Welcome Page', 'vw-restaurant-lite' ) .'</a></p>';
	echo '</div>';
}
...
function vw_restaurant_lite_scripts() {
	...
	wp_enqueue_style( 'vw-restaurant-lite-customcss', get_template_directory_uri() . '/css/custom.css' );
...
define('VW_RESTAURANT_LITE_FREE_THEME_DOC','https://vwthemes.net/docs/vw-restaurant-lite/','vw-restaurant-lite');
define('VW_RESTAURANT_LITE_SUPPORT','https://www.vwthemes.com/support/vw-theme/','vw-restaurant-lite');
...
define('VW_RESTAURANT_LITE_PRO_DOC','https://www.vwthemes.com/docs/vw-restaurant/','vw-restaurant-lite');
...
if ( ! function_exists( 'vw_restaurant_lite_credit' ) ) {
	function vw_restaurant_lite_credit(){
		echo "<a href=".esc_url(VW_RESTAURANT_LITE_CREDIT)." target='_blank'>".esc_html('VWThemes','vw-restaurant-lite')."</a>";
	}
}
