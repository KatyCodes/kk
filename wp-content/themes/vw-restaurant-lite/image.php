...
<div class="container">
    <?php
        ...
        <div id="our-services" class="services flipInX col-md-8 col-sm-8">
    ...
    <?php }else if($left_right == 'One Column'){ ?>
        <div id="our-services" class="services flipInX col-md-12 col-sm-12">
            <?php while ( have_posts() ) : the_post(); ?>    
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    <div class="entry-content">
                        <h1><?php the_title();?></h1>    
    ...
    <?php }else if($left_right == 'Three Columns'){ ?>
        ...
        <div id="our-services" class="services flipInX col-md-6 col-sm-6">
            <?php while ( have_posts() ) : the_post(); ?>    
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    <div class="entry-content">
                        <h1><?php the_title();?></h1>    
    ...
    <?php }else if($left_right == 'Four Columns'){ ?>
        <div id="sidebar" class="col-md-3 col-sm-3"><?php dynamic_sidebar('sidebar-1');?></div>
        <div id="our-services" class="services flipInX col-md-3 col-sm-3">
            <?php while ( have_posts() ) : the_post(); ?>    
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    <div class="entry-content">
                        <h1><?php the_title();?></h1>    
